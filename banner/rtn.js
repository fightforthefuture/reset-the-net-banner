...
if (typeof _rtn_options.iframe_base_path == "undefined") _rtn_options.iframe_base_path = 'https://fightforthefuture.github.io/reset-the-net-banner/banner/iframe';
...
if (typeof _rtn_options.always_show_banner == "undefined") _rtn_options.always_show_banner = false;
...
function onDomContentLoaded() {
	...
	// Should we show the banner, regardless?
	if (!_rtn_options.always_show_banner && window.location.href.indexOf('ALWAYS_SHOW_RTN_banner') === -1) {
		// Only show once.
		if (_rtn_util.getCookie('_RTN_banner_SHOWN')) {
			return;
		}
	...
	_rtn_util.injectCSS('_rtn_iframe_css', '#_rtn_iframe { position: fixed; left: 0px; bottom: 0px; width: 100%; height: 58px; z-index: 20000; }');
